  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(width: 1, color: SettingsBloc.instance.theme.borderColor),
        // color: SettingsBloc.instance.theme.secondery,
      ),
            ...
            child: Row(
              ...
              children: [
                Column(
                  ...
                  children: [
                    Text(time, style: AppTextStyles.w500.copyWith(fontSize: 18, color: SettingsBloc.instance.theme.hintTextColor)),
                    Text(getLang(name.toLowerCase()), style: AppTextStyles.w700.copyWith(fontSize: 24, color: SettingsBloc.instance.theme.mainTextColor)),
                  ],
                ),
